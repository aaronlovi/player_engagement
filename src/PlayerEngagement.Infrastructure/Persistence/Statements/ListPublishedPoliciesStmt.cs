...
internal sealed class ListPublishedPoliciesStmt : PostgresQueryDbStmtBase {
...
""";
    ...
    protected override IReadOnlyCollection<NpgsqlParameter> GetBoundParameters() =>
        new[] { new NpgsqlParameter("now_utc", _nowUtc) };
    ...
    protected override bool ProcessCurrentRow(DbDataReader reader) {
        Policies.Add(PolicyVersionRowMapper.ReadPolicyVersion(reader));
        return true;
    }
