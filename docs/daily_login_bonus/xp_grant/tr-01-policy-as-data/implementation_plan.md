...
| [ ] | 7 | Admin Console Updates | Extend Angular admin UI (`ui/player-engagement-config-ui`) to manage policy lifecycle (forms, previews, publish flow) leveraging new endpoints. | Provide UX for previewing streak curve outputs; ensure access controls. |
