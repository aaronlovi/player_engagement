...
| 6 | [x] | **Repository hand-off** | Once the slim service exists, refactor `PolicyDocumentRepository` so it handles caching only and delegates data retrieval/mapping to the service. |
