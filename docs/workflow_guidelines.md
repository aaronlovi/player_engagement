...
4. **Document deviations** – if a task can’t meet these standards (e.g., blocked on external dependency), record the reason and next steps in the relevant planning doc.
